...
DROP POLICY IF EXISTS "Anon can read booking slots for availability" ON public.bookings; CREATE POLICY "Anon can read booking slots for availability" ON public.bookings
FOR SELECT
TO anon
