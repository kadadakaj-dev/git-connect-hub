-- Add service_description_sk to cancel_secure_booking return payload.
-- Required so cancellation emails can include the service description.
...
BEGIN
  ...
  IF v_status = 'cancelled' THEN
    ...
    SELECT
      ...
      s.description_sk AS service_description_sk,
      b.date,
      b.time_slot
    FROM public.bookings b
  ...
  -- 5) Return success data for notifications
  RETURN QUERY
  SELECT
    b.id AS booking_id,
    false AS was_already_cancelled,
