    ...
    <Head>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media (prefers-color-scheme: dark) {
          ...
          .code-box { background-color: #2f2f36 !important; color: #6ba3e0 !important; }
    ...
    <Body className="email-body" style={main}>
      <Container className="email-card" style={wrapper}>
        ...
        <Section style={content}>
          <Heading className="text-heading" style={h1}>Overovací kód</Heading>
          <Text className="text-body" style={text}>Použite kód nižšie na overenie vašej identity:</Text>
          <Text className="code-box" style={codeStyle}>{token}</Text>
          <Text className="text-muted" style={footerText}>
            Platnosť kódu je obmedzená. Ak ste o tento kód nežiadali,
            môžete tento e-mail pokojne ignorovať.
          </Text>
        </Section>
...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '28px', fontWeight: 'bold' as const, color: '#4a90d9', margin: '0 0 30px', textAlign: 'center' as const, backgroundColor: '#f0f4f8', padding: '20px', borderRadius: '12px' }
