...
import { Mail, Lock, User, ArrowLeft, CalendarDays, Clock, Heart, Star, Chrome } from 'lucide-react';
                    ...
                    <Tabs defaultValue="login" className="w-full">
                      ...
                      <TabsContent value="login" className="mt-5 space-y-4">
                        ...
                        <Button
                          ...
                          className="h-12 w-full rounded-[14px] border border-[var(--glass-border-subtle)] bg-white/72 text-[hsl(var(--soft-navy))] shadow-[0_10px_24px_rgba(126,195,255,0.08)] hover:bg-white/88 hover:shadow-[0_12px_28px_rgba(126,195,255,0.14)]"
                        >
                          ...
                          {language === 'sk' ? 'Prihlásiť sa cez Google' : 'Sign in with Google'}
                        </Button>
                      </TabsContent>
                      ...
                      <TabsContent value="register" className="mt-5 space-y-4">
                        ...
                        >
                          ...
                          {language === 'sk' ? 'Registrovať sa cez Google' : 'Sign up with Google'}
                        </Button>
                      </TabsContent>
                    </Tabs>
                  </>
