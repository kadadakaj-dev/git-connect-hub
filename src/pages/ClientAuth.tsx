      ...
      <div className="min-h-screen flex bg-gradient-to-br from-primary/90 via-primary/70 to-ring/80 overflow-hidden">
        ...
        <aside className="hidden lg:flex w-[280px] flex-col p-6 bg-white/10 backdrop-blur-2xl border-r border-white/10">
          ...
          <div className="mt-auto p-4 bg-white/12 rounded-2xl border border-white/10 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-white">{language === 'sk' ? 'Hosť' : 'Guest'}</p>
          ...
          <div className="flex-1 flex items-center justify-center p-4 lg:p-8">
            <div className="w-full max-w-md space-y-6">
              ...
              <div className="text-center lg:text-left mb-2">
                ...
                <p className="text-base text-white/70">{text.welcomeSub}</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-2xl rounded-3xl border border-white/15 shadow-[0_8px_32px_rgba(0,0,0,0.12)] p-6 lg:p-8 space-y-6">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full h-12 flex items-center justify-center gap-3 rounded-2xl bg-white/15 hover:bg-white/25 border border-white/10 hover:border-white/20 text-white font-medium text-[15px] transition-all duration-200 disabled:opacity-50"
                  >
                  ...
                  <TabsContent value="login" className="space-y-4 mt-5">
                    <form onSubmit={handleEmailSignIn} className="space-y-4">
                      <div className="space-y-1.5">
                        <Label htmlFor="login-email" className="text-white/80 text-sm font-medium">{text.email}</Label>
                        <div className="relative">
                    ...
                    <form onSubmit={handleEmailSignUp} className="space-y-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Input
                          id="register-phone"
                          type="tel"
                          className="h-11 bg-white/10 border-white/15 text-white placeholder:text-white/30 rounded-xl focus:border-white/40 focus:ring-white/20"
                          value={formData.phone}
                          onChange={(e) => setFormData({ ...formData, phone: e.target.value })}
                        />
                      </div>
                      <div className="space-y-1.5">
                        <Label htmlFor="register-password" className="text-white/80 text-sm font-medium">{text.password}</Label>
                        <div className="relative">
                          <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-white/40" />
                          <Input
