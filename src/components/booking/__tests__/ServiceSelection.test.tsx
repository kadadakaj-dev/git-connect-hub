...
describe('ServiceSelection', () => {
    ...
    it('should visually indicate the selected service', () => {
        ...
        // The selected service button should have primary border styling
    ...
    it('should render express service as a telephone link', () => {
        ...
        const expressLink = screen.getByText('Zavolajte nám').closest('a');
        expect(expressLink).toBeInTheDocument();
        expect(expressLink).toHaveAttribute('href', 'tel:+421905307198');
    });
    ...
    it('should display express badge text', () => {
        ...
        expect(screen.getByText('Do 36h · víkendy · sviatky')).toBeInTheDocument();
    });
