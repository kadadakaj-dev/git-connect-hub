...
const TimeGridView = ({
  ...
  const weekMinWidth = Math.max(840, Math.round(840 * zoom));
    ...
    <div className="flex flex-col flex-1 overflow-hidden">
      <div className="flex flex-shrink-0 border-b border-[var(--glass-border-subtle)] bg-[linear-gradient(180deg,rgba(255,255,255,0.48)_0%,rgba(234,246,255,0.24)_100%)]">
        ...
        <div
          ...
          style={viewMode === 'week' ? { minWidth: `${weekMinWidth}px` } : undefined}
        >
                ...
                {dayEvents.map(event => {
                  ...
                  return (
                    <div
                      ...
                      className={`absolute rounded-lg sm:rounded-xl p-1 sm:p-1.5 md:p-2.5 shadow-[0_10px_22px_rgba(126,195,255,0.12)] cursor-grab active:cursor-grabbing hover:shadow-[0_16px_28px_rgba(126,195,255,0.16)] transition-all overflow-hidden flex flex-col z-10 min-h-[60px] ${colorClasses}`}
                      style={event.style}
                      onClick={(e) => { e.stopPropagation(); onEditEvent(event); }}
                    >
                      <div className="font-bold leading-tight text-[11px] md:text-sm whitespace-normal break-words pr-2">
                      ...
                      {isSmall && (
                        <div className="font-normal leading-tight opacity-80 text-[9px] md:text-[10px] whitespace-normal break-words pr-1">
