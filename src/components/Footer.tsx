...
const Footer = () => {
  ...
  const contactInfo = [
    ...
    { icon: Mail, text: 'info@fyziofit.sk', href: 'mailto:info@fyziofit.sk' },
  ...
  return (
    <footer className="w-full border-t border-border/60 bg-card mt-auto">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6">
        ...
        {/* Legal */}
        <div className="mt-5 pt-4 border-t border-border/40 flex flex-col sm:flex-row items-center justify-between gap-3">
